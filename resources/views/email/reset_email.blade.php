...
<div class="box" style="background-color: #f6f6f6; width: 100%; max-width: 800px; margin: 85px auto;">
    <div class="box-img" style="text-align: center;">
        <img src="{{asset('images/logo1@2x.png')}}" style="width: 100px;margin-top: -50px">
    </div>
    <div class="para" style="padding: 0 125px 50px 125px;">
        <p style="text-align: center; font-size: 23px; font-family: 'GFS Didot', serif;">Changing Your Shay-int Password</p>
        ...
        <div class="btn">
            <a href="{{$base_url}}reset/{{$token}}" style="background-color: black;color: #f4f4f4;padding: 8px 15px;border: none;margin-top: 20px;font-size: 11px;text-decoration: none;">Reset My Password</a>
        </div>
